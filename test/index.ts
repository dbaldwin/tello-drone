...
describe("tello-drone library", function () {
    ...
    it("Can verify valid commands", function () {
        ...
        const optionCommands = ["go", "up", "down", "ccw", "flip", "curve", "EXT led", "EXT DIY"];
        const options = [{ x: 100, y: 100, z: 100, speed: 50, mid: 3 }, { value: 200 }, { value: 50 }, { value: 180 }, { value: "r" }, { x1: 250, y1: 100, z1: 100, x2: 100, y2: 50, z2: 50, speed: 30 }, { r: 199, g: 255, b: 10 }, { value: "servo open" }];
